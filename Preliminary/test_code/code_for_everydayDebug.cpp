...
#ifdef Debug1
            if(serverId!=-1){
                printServerStatus(serverId,serverLoad,curDemand);
            }
#endif
...
//                cout<<endl;
                ...
                if(curNeed>=server_Best_Costs[serverId]||curNeed>=serverLoad[serverId]){    //使用这一次的机会
...
#ifdef Debug1
                    cout<<"After using an opportunity: "<<endl;
                    printServerStatus(serverId,serverLoad,curDemand);
#endif
